...
struct material {
	...
	GLint base_color_texture; //indice della color texture
	float metallic_factor;
	GLint metallic_texture; //indice della metallic map
	float roughness_factor;
	GLint roughness_texture; //indice della roughness map
	GLint normal_texture; //indice della normal map
	GLint emissive_texture; //indice della texture emissive

	//initialize a material with a name and setting all textures to -1
	void init(std::string material_name) {
		name = material_name;
